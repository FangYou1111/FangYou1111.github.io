    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="this.$route.query.categoryName">
              {{ this.$route.query.categoryName
              }}<i @click="removeCategoryName">x</i>
            </li>
            <li class="with-x" v-if="this.$route.params.keyWord">
              {{ this.$route.params.keyWord
              }}<i @click="removeKeyWordName">x</i>
            </li>
                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span
                      ...
                      class="iconfont"
                      :class="{
                        'icon-24gl-arrowDown2': isDown,
                        'icon-24gl-arrowUp2': isUp,
                      }"
                    ></span
                  ></a>
                </li>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag) {
      let oldByOne = this.searchParams.order.split(":")[0];
      let oldByTwo = this.searchParams.order.split(":")[1];
      if (flag === oldByOne) {
        this.searchParams.order = `${flag}:${
          oldByTwo === "desc" ? "asc" : "desc"
        }`;
      } else {
